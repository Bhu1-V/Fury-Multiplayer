...
namespace Fury.Weapons {
    ...
    public class Grenade : NetworkBehaviour, IThrowable {
        ...
        /// <summary>
        /// Thrown By which Player
        /// </summary>
        [Tooltip("Thrown by which player")]
        [SerializeField]
        protected UserData _thrownByUser;
        #endregion
        ...
        /// </summary>
        [Server(Logging = LoggingType.Off)]
        public virtual void Initialize(PreciseTick pt, Vector3 force, UserData thrownBy) {
            //No ignore time.
