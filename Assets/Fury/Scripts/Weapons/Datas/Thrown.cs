...
namespace Fury.Weapons {
    ...
    public class Thrown : Weapon {
        ...
        /// </summary>
        public override void Fire(PreciseTick pt, Vector3 position, Vector3 direction, NetworkRoles networkRoles, UserData _thrownBy = null) {
            ...
            base.Fire(pt, position, direction, networkRoles, _thrownBy);
            ...
            base.ThrownInstantiateRequired(new ThrownInstantiateEventArgs(this, pt, position, direction, force, _instantiateOnServerOnly, _thrownPrefab, thrownBy: _thrownBy));
