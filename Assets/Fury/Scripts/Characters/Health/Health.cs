...
namespace Fury.Characters.Vitals {
    ...
    public class Health : NetworkBehaviour {
        ...
        public static event Action<Health> OnGlobalDeathEvent;
        /// <summary>
        ...
        public void RestoreHealth() {
            ...
            OnHealthChanged?.Invoke(oldHealth, CurrentHealth, MaximumHealth);
            GlobalOnHealthChanged?.Invoke(this, oldHealth, CurrentHealth, MaximumHealth);
        ...
        public virtual void HealthDepleted() {
            OnDeath?.Invoke();
            OnGlobalDeathEvent?.Invoke(this);
        }
